"""
Do not run locally unless all PySpark, Java, and Delta Lake dependencies are configured.
...
BRONZE_TABLE_SCHEMA = StructType([
    StructField("document_id", StringType(), False),  # Now stores the Celex ID
...
def ingest_metadata_to_bronze(spark: SparkSession, downloaded_files: list, catalog: str = "accenture2026dbcks", schema: str = "team2"):
    ...
    """
    table_name = f"{catalog}.{schema}.Bronze_layer"
    ...
    for file_info in downloaded_files:
        records.append((
            file_info["document_id"],  # Maps the Celex ID value passed from setup
            file_info["file_name"],
            file_info["file_path"],
            "EUR-Lex",
            "RAW_DOWNLOADED",
    ...
    print(f"Successfully processed {len(records)} metadata records to {table_name} using PySpark Dataframe API.")
...
if __name__ == "__main__":
    ...
    # document_id is now explicitly assigned the Celex IDs to align with your indexing logic
    production_files = [
        {"document_id": "32022R2554", "file_name": "32022R2554_EN.pdf", "file_path": "/Volumes/accenture2026dbcks/team2/volume/32022R2554_EN.pdf"},
        {"document_id": "32018L0843", "file_name": "32018L0843_EN.pdf", "file_path": "/Volumes/accenture2026dbcks/team2/volume/32018L0843_EN.pdf"},
        {"document_id": "32014L0065", "file_name": "32014L0065_EN.pdf", "file_path": "/Volumes/accenture2026dbcks/team2/volume/32014L0065_EN.pdf"},
        {"document_id": "32016R0679", "file_name": "32016R0679_EN.pdf", "file_path": "/Volumes/accenture2026dbcks/team2/volume/32016R0679_EN.pdf"},
        {"document_id": "32024R1689", "file_name": "32024R1689_EN.pdf", "file_path": "/Volumes/accenture2026dbcks/team2/volume/32024R1689_EN.pdf"}
    ]
